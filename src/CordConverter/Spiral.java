...
public class Spiral extends JFrame implements ActionListener
{
	...
	Spiral(Edytor parent)
	{
		setPreferredSize(new Dimension(330,450));
		setTitle("Generuj spiralê");
		...
		// labels
		 wspolrzedneXLabel =  new JLabel("Wspó³rzêdna x otworu");
		 wspolrzedneYLabel = new JLabel("Wspó³rzêdna y otworu ");
		 ...
		 rodzajLabel.setToolTipText("Sposób generowania œcie¿ki dla tej operacji");
	...
	public void actionPerformed(ActionEvent arg0) {
			...
			{		
				...
				else
				{
					...
					else
					{
						...
						parent.writelog("Wygenerowano makro do interpolacji spiralnej dla otworu o wspo³rzêdnych X=" +x + " Y=" + y + " Zpocz=" +start+" Zkonc="+ bottom+".\n\tSrednica frezowanego otworu: "+ holeDiameter +"mm "+ " Srednica wykorzystanego narzedzia:"+toolDiameter + "mm"+"\n\tAp="+step+"mm"+"\n\tS"+spSpeed+" 1/s"+" F"+feed+"mm/min");
		...
		else if(o==macroCheck)
		{
			...
			{
				JOptionPane.showMessageDialog(this, "Opcja dostêpna tylko na sterowaniu Fanuc", "Niedostêpna opcja", JOptionPane.OK_OPTION);
