...
public class Faza extends JFrame implements ActionListener {
	...
	public Faza(Edytor parent)
	{
		...
		wspolrzednaXLabel = new JLabel("Wpó³rzêdna X");
		border.gridx=0;
		border.gridy=0;
		...
		wspolrzednaYLabel = new JLabel("Wpó³rzêdna Y");
		border.gridy=1;
		...
		border.gridy=2;
		srednicaNarzedziaLabel = new JLabel("Œrednica narzedzia");
		srednicaNarzedziaLabel.setToolTipText("Œrednica narzedzia zmierzona na ostrzu bior¹cym udzia³ w skrawaniu. Dlugoœæ narzêdzia nale¿y zmierzyæ w tym samym punkcie");
		add(srednicaNarzedziaLabel,border);
		
		//x0 y3 srednica otworu label
		border.gridy=3;
		srednicaOtworuLabel = new JLabel("Œrednica otworu d");
		...
		border.gridy=4;
		glebokoscFazyLabel = new JLabel("G³êbokoœæ fazy z");
		glebokoscFazyLabel.setToolTipText("G³êbokoœæ fazu podana w mm mierzona równolegle do osi otworu");
		add(glebokoscFazyLabel,border);
		
		//x0 y5 wspol z otowru label
		border.gridy=5;
		zPlaszczyznyLabel = new JLabel("Wspó³rzêdna Z pocz¹tku otworu");
		zPlaszczyznyLabel.setToolTipText("Wspó³rzêdna Z p³aszczyzny w której wywiercony jest otwór przeznaczony do fazowania");
	...
	private void generuj()
	{
		...
		if(parent.getControls().isType(ControlTypes.SINUMERIC))
			...
			+ "\n\t g³êbokoœæ fazy: " + String.format(Locale.CANADA,"%.1f", glebokoscFazy)+ "mm"
			+ "\n\t pomiar narzêdzia na œrednicy: " + String.format(Locale.CANADA,"%.2f", this.srednicaNarzedzia) +"mm"
					);
	}
	...
	private boolean isOk()
	{
		...
		{
			JOptionPane.showMessageDialog(this, "Zle zdefiniowana wspó³rzêdna X");
			return false;
		}
		...
		{
			JOptionPane.showMessageDialog(this, "Zle zdefiniowana wspó³rzêdna Y");
			return false;
		}
		...
		try 
		{
			...
			{
				JOptionPane.showMessageDialog(this, "Œrednica narzêdzia podejrzanie ma³a");
				return false;
			}
		...
		{
			JOptionPane.showMessageDialog(this, "Zle zdefiniowana œrednica narzêdzia");
			return false;
		}
		...
		try 
		{
			...
			if(srednicaOtworu<1)
			{
				JOptionPane.showMessageDialog(this, "Œrednica otworu podejrzanie ma³a");
				return false;
			}		
		...
		{
			JOptionPane.showMessageDialog(this, "Zle zdefiniowana g³êbokoœæ fazy");
			return false;
		}
		...
		{
			JOptionPane.showMessageDialog(this, "Zbyt ma³e narzêdzie do tego otworu");
			return false;
		}
