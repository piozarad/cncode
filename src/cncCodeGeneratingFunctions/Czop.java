...
import DrawFunction.DrawTool;
	...
	{	
		...
		static final String[] METODA_FREZOWANIA= {"Spiralnie", "Okrag-zaglebienie"};
		
		
		
		
		
		public Czop(Edytor parent)
		{
			setSize(450,600);
			...
			// labels
			 wspolrzedneXLabel =  new JLabel("Wspolrzedna x czopu");
			 wspolrzedneYLabel = new JLabel("Wspolrzedna y czopu ");
			 ...
			 krokLabel = new JLabel("Gleboko¶c skrawania ap");
			 ...
			 rodzajSpirali.setToolTipText("Zaprogramuj œciezke spiralnie wokol czopa / œciezka skladaj¹ca sie z okregow na osi Z");
			...
			{		
				...
				else
				{
						...
						if(this.rodzajCombo.getSelectedIndex()==1) {
							...
							parent.writelog("Wygenerowano interpolacje spiralna wokol trzpienia o wspolrzednych X=" +x + " Y=" + y + " Zpocz=" +start+" Zkonc="+ bottom+".\n\tSrednica frezowanego trzpienia: "+ holeDiameter +"mm "+ " Srednica wykorzystanego narzedzia:"+toolDiameter + "mm"+"\n\tAp="+step+"mm"+"\n\tS"+spSpeed+" 1/s"+" F"+feed+"mm/min");
