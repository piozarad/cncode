...
public class Przepona extends JFrame implements ActionListener{
	...
	static final String PRZYBIERANIE_TOOLTIP = "<html>Definiuje punkt w ktorym narzedzie bedzie sie zaglebialo w osi Z.<br>Punkt powinien znajdowac sie poza materialem</html>";
	...
	public Przepona(Edytor edytor)
	{
		...
		wspolrzedneLabel = new JLabel("Wspolrzedne srodka przepony:");
		buttonPanel.add(wspolrzedneLabel,border);
		
		//y1
		xSrodkaLabel = new JLabel("X srodka:");
		border.gridx=0;
		border.gridy=1;
		buttonPanel.add(xSrodkaLabel,border);
		
		//y2
		ySrodkaLabel = new JLabel("Y srodka:");
		border.gridx=0;
		border.gridy=2;
		buttonPanel.add(ySrodkaLabel,border);
		
		//y3 szerokosc
		szerokoscLabel = new JLabel("Szerokosc przepony w osi x:");
		border.gridx=0;
		border.gridy=3;
		buttonPanel.add(szerokoscLabel,border);
		
		//y4 wysokoúc
		wysokoscLabel = new JLabel("Wysokosc przepony w osi y:");
		border.gridx=0;
		border.gridy=4;
		...
		//y7 fi narzedzia
		fiNarzedziaLabel = new JLabel("Sednica narzedzia");
		border.gridx=0;
		border.gridy=7;
		buttonPanel.add(fiNarzedziaLabel,border);
		
		//y8
		apLabel = new JLabel("Zaglebianie Ap:");
		border.gridx=0;
		border.gridy=8;
		...
		obrotyLabel.setToolTipText("Predkoúc obrotowa wrzeciona. Mozna podac predkosc skrawania w celu obliczenia obrotow wg formatu: Vc=wartosc");
		border.gridx=0;
		border.gridy=10;
		...
		posuwLabel.setToolTipText("Predkoúc posuwu Vf w mm/min. Mozna podac posow na zab i liczbe zebow w celu obliczenia predkosci posuwu wg schematu fn=wartosc z=wartosc");
		border.gridx=0;
		border.gridy=11;
	...
	class Visual extends JPanel
	{
		...
		Visual(Dimension dim)
		{
			...
			showCordinatesButton.setToolTipText("Pokaz punkt zerowy ukladu wspolrzednych");
			...
			showLegendButton.setToolTipText("Pokaz objaúnienia");
	...
	{ 
		...
		if(this.sterowanie.isType(ControlTypes.FANUC)) System.out.printf(Locale.CANADA,"N%d D%d%n", n+=5, toolNumber);
		...
		if(this.advancePoint.equals("xZeroYPlus"))
		{
			...
			edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nsrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nSrednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z w punkcie X" + advance.getX() + " Y"+ advance.getY() );
		}	
			...
			System.out.printf(Locale.CANADA,"N%d G41 G1 X%.3f Y%.3f F%.1f%n",n+=5, advance.getX(), advance.getY(),feed);
				...
				edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nåsrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nSrednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z w punkcie X" + advance.getX() + " Y"+ advance.getY() );
			}
		...
		else if(this.advancePoint.equals("x_plus_y_minus"))
		{
			...
			System.out.printf(Locale.CANADA,"N%d G40 G1 X%.3f Y%.3f%n",n+=5, advance.getX()-2, advance.getY()+2);
			edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nSrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nårednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z w punkcie X" + advance.getX() + " Y"+ advance.getY() );
		}	
	...
	//Rampa
		...
		else if(this.advancePoint.equals("X+"))
		{
			...
			edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nSrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nårednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z po rampie w kierunku X+");
		...
		{	
			...
			edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nSrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nårednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z po rampie w kierunku Y+");
		...
		else if(this.advancePoint.equals("X+ i X-"))
		{
			...
			System.out.printf(Locale.CANADA,"N%d G40 G1 X%.3f%n",n+=5, x);
			edytor.writelog("Wygenerowano frezowanie przepony dla danych: %nSrodek symetrii przepony X" + x + " Y"+ y + "%nWymiary przepony: "+ width + " na " +height + "%nårednica uzytego narzedzia: " + toolDiameter +"mm"+ "%nPrzybieranie w osi Z po rampie w kierunkach X+ i X-");
		...
		else JOptionPane.showMessageDialog(this.edytor, "Nieprzewidziana sytuacja - to na pewno wina Skoczylasa!", "Blad", JOptionPane.ERROR_MESSAGE);
	...
	private boolean isOk()
	{
		...
		//point
			...
			{
				JOptionPane.showMessageDialog(this, "Musisz zdefiniowac punkt w ktorym bedzie przybierana oú Z", "Blad", JOptionPane.OK_OPTION);
		...
		{		
			...
			JOptionPane.showMessageDialog(this, "Zle zdefiniowana wartoúc wspolrzednej x srodka przepony", "Blad", JOptionPane.OK_OPTION);
			return false;
		}
		...
		//y
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wartoúc wspolrzednej y súrodka przepony", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
			...
			//height
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wartoúc wysokosci przepony", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
		...
		//width
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wartosc szerokosci przepony", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
		//fi narzedzia
				try 
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana Srednica narzedzia", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
		//ap
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wartoúc ap", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
		//speed
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana predkoúc obrotowa wrzeciona", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
		//feed
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wartoúc posuwu", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
			...
			// z kon
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowany wspolrzedna Z koncowa", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
			...
			//z kon	
				...
				{		
					...
					JOptionPane.showMessageDialog(edytor, "Zle zdefiniowana wspolrzedna Z poczatkowa ", "Blad", JOptionPane.OK_OPTION);
					return false;
				}
				...
				if(toolDiameter <1)
				{
					JOptionPane.showMessageDialog(edytor,"Zbyt mala úrednica narzedzia", "Blad",JOptionPane.ERROR_MESSAGE);
					return false;
				}
				...
				{
					JOptionPane.showMessageDialog(edytor,"årednica narzedzia jest wieksza od wysoksci przepony", "Blad",JOptionPane.ERROR_MESSAGE);
					return false;
				}
				...
				{
					JOptionPane.showMessageDialog(edytor,"årednica narzedzia jest wieksza od szerokosci przepony", "Blad",JOptionPane.ERROR_MESSAGE);
					return false;
				}
				...
				if(z_pocz < z_kon)
				{
					JOptionPane.showMessageDialog(edytor,"Z poczatkowy jest mniejszy od Z koncowego", "Blad",JOptionPane.ERROR_MESSAGE);
					return false;
				}
				if((width-toolDiameter<=0) || (height-toolDiameter<=0) )
				{
					JOptionPane.showMessageDialog(this, "Zbyt mala srednica narzedzia");
					return false;
				}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o==oblicz)
		{
			...
			{		
				if(z_pocz >z_kon)
				{
					...
					JOptionPane.showMessageDialog(edytor, "Wspolrzedna poczatkowa Z powinna byc wieksza od koncowej", "Blad", JOptionPane.OK_OPTION);
			}
		...
		else if(o==pktPrzybrania)
		{
			...
			int answer = JOptionPane.showOptionDialog(this, "Przybieraj ", "Wybierz sposob zaglebiania sie w osi Z", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
