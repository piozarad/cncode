...
public class Pocket extends JFrame implements ActionListener{
	...
	public Pocket(Edytor parent)
	{
	 ...
	 border = new GridBagConstraints();
		...
		//x0 y0
		startingPointLabel = new JLabel("Srodek symetrii kieszeni");
		startingPointLabel.setToolTipText("Punkt przeciecia osi symetrii osi X i Y kieszeni");
		border.gridx=0;
		border.gridy=0;
		add(startingPointLabel,border);
		
		//x1
		xStartingPointTxt = new JTextField("(Wspolrzedna X0)");
		...
		//x2
		yStartingPointTxt = new JTextField("(Wspolrzedna Y0)");
		...
		//x0 y1
		//width
		widthLabel = new JLabel("Szerokosc rowka d");
		widthLabel.setToolTipText("Szerokosc frezowanej kieszeni w mm");
		border.gridx=0;
		border.gridy=1;
		...
		//x0 y2
		//height
		heightLabel = new JLabel("Wysokosc rowka h");
		heightLabel.setToolTipText("Wysokosc frezowanego rowka w mm");
		border.gridx=0;
		border.gridy=2;
		...
		startingZ.setToolTipText("Wsplrzedna, ktra okresla poczatek frezowania kieszeni w osi Z");
		border.gridx=0;
		border.gridy=3;
		...
		//x0 y5
		toolSizeLabel = new JLabel("Srednica narzedzia");
		toolSizeLabel.setToolTipText("Srednica u¿ytego narzedzia podana w mm");
		border.gridx=0;
		border.gridy=5;
		...
		speedUnitLabel.setToolTipText("obroty na minute");
		border.gridx=2;
		border.gridy=6;
		...
		FeedLabel.setToolTipText("Predkosc posuwu Vf w mm/min. Mo¿na podac posow na zab i liczbe zebow w celu obliczenia predkosci posuwu wg schematu fn=wartosc z=wartosc");
		border.gridx=0;
		border.gridy=7;
		...
		feedUnitLabel.setToolTipText("milimetry na minute");
		border.gridx=2;
		border.gridy=7;
		...
		apLabel.setToolTipText("Glebokosc skrawania - zaglebiania sie narzedzia na ka¿dym przejsciu  w osi Z");
		border.gridx=0;
		border.gridy=8;
		add(apLabel,border);
		...
		turnLabel.setToolTipText("Zamienia kieszen pozioma na pionowa");
		border.gridx=0;
		border.gridy=9;
		...
		turnCombo.setToolTipText("Zamienia kieszen pozioma na pionowa");
	...
	private class canva extends JPanel
	{
		...
		public canva()
		{
			...
			g.drawString("a - prosta zaglebiania sie osi Z", 30, 290);
			...
			//sciezka narzedzia
			g.drawString("sciezka narzedzia", 70, 260);
	...
	private class canv extends JPanel
	{
		...
		g.drawString("a - prosta zaglebiania sie narzadzia w osi Z", 50, 220);
	...
	private boolean isOk()
	{
		...
		{
			JOptionPane.showMessageDialog(parent,"Zle zdefiniowana szerokosc kieszeni");
			return false;
		}
		...
		{
			JOptionPane.showMessageDialog(parent,"Zle zdefiniowana wysokosc rowka");
			return false;
		}
		try
		{
		...
		{
			JOptionPane.showMessageDialog(parent,"Zle zdefiniowana wsplrzedna startowa Z");
			return false;
		}
		try
		{
		...
		{
			JOptionPane.showMessageDialog(parent,"Zle zdefiniowana wsplrzedna dna kieszeni");
			return false;
		}
		...
		{
			JOptionPane.showMessageDialog(this, "Srednica narzedzia za mala na taka kieszeñ");
		...
		if(width <11)
		{
			JOptionPane.showMessageDialog(this, "Za mala szerokosc kieszeni");
		
			return false;
		}
		if(height <11)
		{
			JOptionPane.showMessageDialog(this, "Za mala wysokosc kieszeni");
		...
		{
			JOptionPane.showMessageDialog(this, "Wysokosc kieszeni powinna byc wieksza od jej dlugosci");
		...
		if(!this.turnCombo.isSelected() && this.width <this.height)
		{
			JOptionPane.showMessageDialog(this, "Wysokosc kieszeni powinna byc mniejsza od jej dlugosci");
